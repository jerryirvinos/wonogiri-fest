    ...
    <div class="card card-flush">
        <div class="card-header pt-lg-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fs-2 fw-bolder text-gray-800">Edit LineUp</span>
                <span class="fs-6 fw-normal text-gray-400 mt-1">Modul untuk merubah Line Up</span>
            </h3>
            <div class="card-toolbar">
                <a href="{{ route('lineup.index') }}" class="btn btn-active-light-danger">
        ...
        <div class="card-body px-0 px-lg-3 px-0 px-lg-3">
            <div class="card-body">
                <form class="form fv-plugins-bootstrap fv-plugins-framework mt-5" method="POST"
                    enctype="multipart/form-data" action="{{ route('lineup.update', $lineup->id) }}">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 mb-10 mb-lg-2">
                            <div class="mb-10">
                                ...
                                <input type="text" class="form-control form-control-lg" name="title"
                                    value="{{ $lineup->title }}" placeholder="Kuburan Band">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xl-6 col-sm-12">
                                        ...
                                        <div class="image-input image-input-empty" data-kt-image-input="true"
                                            style="background-image: url({{ $lineup->thumbnail }})">

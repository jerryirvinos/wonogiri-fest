...
<div class="card card-flush shadow-sm">
    ...
    <div class="card-body">
        <form class="form fv-plugins-bootstrap fv-plugins-framework mt-5" method="POST" enctype="multipart/form-data"
            action="{{ route('lineup.update', $lineup->id) }}">
            @csrf
            @method('put')
            <div class="mb-5">
                <label class="form-label fs-7 text-gray-700">Title</label>
                <input type="text" class="form-control form-control-lg" name="title" value="{{ $lineup->title }}"
                    placeholder="Kuburan Band">
                ...
                <div class="row justify-content-start">
                    <div class="col-xl-12 col-xxl-7">
                        ...
                        <div class="image-input image-input-empty bgi-no-repeat bgi-size-cover bgi-position-x-center min-h-300px min-h-lg-600px h-auto w-100 shadow shadow-sm border border-white border-5 rounded-3"
                            data-kt-image-input="true" style="background-image: url({{ $lineup->thumbnail }})">

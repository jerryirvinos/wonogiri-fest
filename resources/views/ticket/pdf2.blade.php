                        ...
                        <div class="col-sm-12 col-xl-10 col-xxl-10">
                            <div class="row mb-2 mb-lg-10">
                                <div class="col-8 bg-secondary py-1">
                                    <div class="d-flex justify-content-between">
                                        <div
                                            ...
                                            <img class="mx-auto h-125px h-lg-350px theme-light-show"
                                                src="{{ asset('/assets/media/illustrations/gunungan.png') }}"
                                                alt="">
                                        </div>
                                        <div
                                            ...
                                            <img class="mx-auto h-125px h-lg-400px theme-light-show"
                                                src="{{ asset('/assets/media/illustrations/gunungan2.png') }}"
                                                alt="">
                                        </div>
                                    </div>
                                ...
                                <div class="col-4 bg-danger">
                                    <div class="d-flex align-content-center justify-content-end flex-wrap h-100">
                                        <div
                                            class="text-center mx-0 mx-lg-5 px-1 px-lg-5 py-1 py-lg-5 rounded-3 shadow border border-3 border-white bg-white mb-0 mb-lg-5">
                            ...
                            <div class="flex-wrap">
                                <ol class="list-group list-group-numbered">
                                    <li
                                        class="list-group-item bg-transparent border-0 text-white fs-8 fs-lg-4 fw-bold pt-0 pt-lg-2">

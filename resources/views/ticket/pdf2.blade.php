    ...
    <div class="container pt-0 pt-lg-10">
        <div class="card" style="background-color:#0d509f !important;">
            {{-- <img class="mx-auto w-100 img-fluid" src="{{ asset('/assets/media/illustrations/bg_ticket.jpg') }}"
                alt=""> --}}
            <img class="mx-auto w-100 img-fluid" src="{{ asset('/assets/media/illustrations/bg_ticket_header.png') }}"
                alt="">
            <div class="card-body">
                <div class="row mb-2 mb-lg-10">
                    <div class="col-8 py-1" style="background-color:#E4E6EF !important;">
                    ...
                    <div class="col-4" style="background-color:#f1416c !important;">
                ...
                <div class="fs-4x text-white font-title text-base-2 ls-4" style="color: #eff2f5 !important;">
                    INFORMASI PENTING
                </div>
                <div class="flex-wrap">
            ...
            <img class="mx-auto w-100 img-fluid" src="{{ asset('/assets/media/illustrations/bg_ticket_footer.png') }}"
                alt="">
        </div>
    </div>
</body>

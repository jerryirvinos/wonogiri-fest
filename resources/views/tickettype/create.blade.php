                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 mb-10 mb-lg-2">
                            ...
                            <div class="mb-10">
                                ...
                                <input type="text" class="form-control form-control-lg" name="detail" value=""
                                    placeholder="(2 hari show)">
                                <small class="text-danger">
                                    @error('detail')
                                        {{ $message }}
                                    @enderror

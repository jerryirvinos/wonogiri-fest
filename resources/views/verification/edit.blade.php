    ...
    <div class="card card-flush">
        <div class="card-header pt-lg-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fs-2 fw-bolder text-gray-800">Verifikasi Ticket : WF-002354</span>
                <span class="fs-6 fw-normal text-gray-400 mt-1">Modul untuk verifikasi hasil pembelian ticket dari
                    User</span>
            </h3>
            <div class="card-toolbar">
                <a href="#" class="btn btn-active-light-danger">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12 mb-10 mb-lg-2">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea class="form-control form-control-lg form-control-solid" data-kt-autosize="true" readonly>Lorem ipsum dolor sit amet consectetur.
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-12 mb-10 mb-lg-2">

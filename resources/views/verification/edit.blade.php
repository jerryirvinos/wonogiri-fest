            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 mb-10 mb-lg-2">
                    ...
                    <div class="mb-10">
                        ...
                        <textarea class="form-control form-control-lg form-control-solid" data-kt-autosize="true"
                    ...
                    <div class="border border-light rounded-3 shadow-xs px-5 py-6">
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-lg" data-control="select2"
                                ...
                                <option value="{{ $bank->id }}" {{ $order->bank == $bank->id ? 'selected' : '' }}
                    ...
                    <div class="w-100 h-auto rounded-4 px-5 px-lg-15">
                        <div
                            ...
                            <div class="d-none" id="qr-code">{!! QrCode::size(250)->generate(
                                json_encode(['ticketCode' => $order->ticket_code, 'id' =>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <div class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-3">
                                                        {{ $item->name }}
                                                    </div>

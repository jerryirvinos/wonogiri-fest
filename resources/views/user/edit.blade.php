    ...
    <div class="card card-flush">
        <div class="card-header pt-lg-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fs-2 fw-bolder text-gray-800">Edit User</span>
                <span class="fs-6 fw-normal text-gray-400 mt-1">Modul untuk mengubah user</span>
            </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 mb-10 mb-lg-2">
                            ...
                            <div class="mb-10">
                                ...
                                <textarea class="form-control form-control-lg" data-kt-autosize="true" name="address">{{ $user->address }}</textarea>
                                <small class="text-danger">
                                    @error('address')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-10">
                                ...
                                <input type="number" class="form-control form-control-lg" name="phone"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    placeholder="Masukkan No HP" maxlength="13" value="{{ $user->phone }}">
                                <small class="text-danger">
                                    @error('phone')
                                        {{ $message }}
                                    @enderror

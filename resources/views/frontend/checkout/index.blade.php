                            ...
                            <div class="mb-5">
                                ...
                                <div class="flex-column current" data-kt-stepper-element="content">
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <textarea class="form-control form-control-lg" data-kt-autosize="true"
                                            id="address" name="address" placeholder="Masukan alamat lengkap"
                                            value=""></textarea>
                                    </div>
                                    <div class="fv-row mb-5">
                                                ...
                                                <div class="accordion-body">
                                                        ...
                                                        <div class="d-flex justify-content-between flex-wrap px-2">
                                                            <div class="d-flex align-items-center flex-wrap">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <div class="fs-3 fw-bolder text-gray-900 lh-1 mb-2">
                                                                        Bank Mandiri
                                                                    </div>
                                                    ...
                                                    <label
                                                        ...
                                                        <div class="d-flex justify-content-between flex-wrap px-2">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="radio" id="bca"
                                                                    name="bank" value="" />
                                                            </div>
                                                        </div>
                                                    </label>
                                                ...
                                                <div class="accordion-body">
                                                    <label class="form-check-label" for="manual">
                                                        <div
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input class="form-check-input" type="radio" id="manual"
                                                                    name="bank" value="" />
                                                                <span
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-flex justify-content-between flex-wrap">
                                <div class="fs-6 text-gray-800">
                                    Jumlah ticket <span class="fw-bold text-gray-700">(x3)</span>
                                </div>

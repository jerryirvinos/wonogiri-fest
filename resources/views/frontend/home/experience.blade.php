                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4">
                            <div class="d-flex justify-content-center flex-wrap h-100">
                                <img src="{{ asset('/assets/media/illustrations/bazar-kuliner.png') }}"
                                    class="mh-250px mw-100 mb-9 my-auto mx-2" alt="">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4">
                            <div class="d-flex justify-content-center flex-wrap h-100">
                                <img src="{{ asset('/assets/media/illustrations/umkm-corner.png') }}"
                                    class="mh-250px mw-100 mb-9 my-auto mx-2" alt="">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4">
                            <div class="d-flex justify-content-center flex-wrap h-100">
                                <img src="{{ asset('/assets/media/illustrations/music-concert.png') }}"
                                    class="mh-250px mw-100 mb-9 my-auto mx-2" alt="">
                            </div>
                        </div>
                    </div>
